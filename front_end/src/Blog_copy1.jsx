...
const Blog = () => {
    ...
    const handleEditComment = async (commentId) => {
        // Add your logic to edit the comment with the given commentId
    };
                ...
                <img src="images/certificate.jpg" />
                    ...
                    {comments.map((comment, index) => (
                        <div key={index} className="comment">
                            <p><strong>{comment.author}:</strong> {comment.content}</p> {/* Change comment.name to comment.author */}
                            <div className="comment-actions">
                                <button onClick={() => handleEditComment(comment._id)}>Edit</button> {/* Change comment.id to comment._id */}
                                <button onClick={() => handleDeleteComment(comment._id)}>Delete</button> {/* Change comment.id to comment._id */}
                            </div>
                        </div>
                    ))}
                </div>
